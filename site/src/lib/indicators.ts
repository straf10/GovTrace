...
export const indicators: IndicatorDefinition[] = [
  ...
  },
  {
    ...
    status: "pending",
    summary: "Στατιστική απόκλιση της κατανομής πρώτων/δεύτερων ψηφίων από την αναμενόμενη κατανομή Benford.",
    formula: "P(d) = log10(1 + 1/d), με MAD/Nigrini thresholds.",
    fields: ["payment/contract amounts"],
    example: "Σε μεγάλο δείγμα ποσών, το πρώτο ψηφίο 1 αναμένεται συχνότερα από το 9.",
    pitfalls: [
      "Ο Benford δεν είναι απόδειξη κανενός ισχυρισμού.",
      "Θέλει μεγάλο δείγμα και ομοιογενή πληθυσμό.",
      "Εκκρεμεί μέχρι να ολοκληρωθεί payment backfill.",
    ],
    nRule: "Σχεδιαζόμενο ελάχιστο N=300.",
  },
  {
    slug: "discount",
    section: "4.6",
